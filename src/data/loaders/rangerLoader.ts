 ...
 */
export async function loadBaseRangerJson(rarity: RangerRarity): Promise<unknown> {
 ...
 */
export async function loadEventRangerJson(event: string, rarity: RangerRarity): Promise<unknown | null> {

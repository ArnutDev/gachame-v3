...
export default function Button({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-semibold rounded-md transition-all duration-200 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed active:scale-95';
  ...
  const variantClasses = {
    ...
    outline: 'bg-transparent text-text-primary border border-border-color hover:border-text-primary/20',
  };
